...
export default function VendorMgmt() {
    ...
    const [data, setData] = useState({
        ...
        tableData: [
        { id: 1, name: 'John Doe', email: 'john@example.com', website: 'www.example.com', phone: '123-456-7890', status: 'Active' },
        { id: 2, name: 'Jane Smith', email: 'jane@example.com', website: 'www.example.com', phone: '123-456-7890', status: 'Inactive' },
        ...
        <SafeAreaView style={{ background: "#e8ecf4", paddingHorizontal: 20 }}>
                ...
                <View style={styles.modal}>
                    <View style={styles.modalContent}>
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Website"
                            onChangeText={(text) => setNewVendor({ ...newVendor, website: text })}
                        />
                        <TextInput
                            style={styles.input}
                            placeholder="Phone"
            ...
            >
                ...
                <View style={styles.modalContentDelete}>
                    ...
                    <Text style={styles.modalTextDelete}>Are you sure you want to delete this vendor?</Text>
            ...
            <View style={styles.modal}>
                <View style={styles.modalContent}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditVendor({ ...editVendor, name: text })}
                    />
                    <TextInput
                        style={styles.input}
                        placeholder="Email"
                        value={editVendor ? editVendor.email : ''}
                        onChangeText={(text) => setEditVendor({ ...editVendor, email: text })}
                    />
                    <TextInput
                        style={styles.input}
                        placeholder="Website"
                        value={editVendor ? editVendor.website : ''}
                        onChangeText={(text) => setEditVendor({ ...editVendor, website: text })}
                    />
                    <TextInput
                        style={styles.input}
                        placeholder="Phone"
